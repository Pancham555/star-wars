...
const Section = () => {
  return (
    <section className="px-6">
      <div className="container px-6 mx-auto py-8 my-10 bg-white dark:bg-gray-800 rounded shadow-xl shadow-gray-3s00">
          ...
          <div className="mt-8 lg:mt-0 lg:w-1/2">
            <div className="flex items-center justify-center lg:justify-end">
              <div className="max-w-lg">
                <div className="relative overflow-hidden w-full h-64 rounded-md shadow">
                  <Image
                    src="/pic.jpg"
                    draggable={false}
                    width={440}
