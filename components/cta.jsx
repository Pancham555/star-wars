...
const Cta = () => {
  return (
    <div className="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row bg-white dark:bg-gray-900">
      <div className="flex justify-center xl:w-1/2">
        {/* <img
          ...
          alt=""
        /> */}
        <div className="relative h-80 w-80 sm:w-[28rem] sm:h-[28rem] flex-shrink-0">
          <Image
            src="/app.jpg"
            draggable={false}
            width={440}
      ...
      <div className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
        ...
        <p className="block max-w-2xl mt-4 text-xl text-gray-500 dark:text-gray-300">
          ...
          recusandae tenetur iste quaerat voluptatibus quibusdam nam repudiandae{" "}
        </p>
