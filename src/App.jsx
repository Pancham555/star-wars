...
function App() {
  ...
  return (
    <>
      <nav className="bg-white w-full border-b md:border-0 md:static font-medium">
        <div className="items-center px-4 max-w-screen-xl mx-auto md:flex md:px-8">
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <a href="javascript:void(0)" className="flex my-auto">
              <img
                src="https://scaliton.vercel.app/swastika.png"
                // width={120}
                // height={50}
                className="w-[4em]"
                alt="Float UI logo"
              />
              <p className="my-auto text-xl">Scaliton</p>
            </a>
          ...
          <div
            className={`flex-1 justify-self-center md:h-auto overflow-hidden  duration-200
            ${state ? "h-48" : "h-0"}`}
          >
            <ul className="grid grid-rows-4 gap-4  md:gap-0 md:space-x-6 md:space-y-0 md:flex md:justify-center md:items-center my-auto">
      ...
      <section className="mt-10 mx-auto max-w-screen-xl pb-4 px-4 items-center lg:flex md:px-8 font-medium">
        <div className="space-y-4 flex-1 sm:text-center lg:text-left my-auto">
        ...
        <div className="flex-1 text-center mt-4 lg:mt-0 lg:ml-3 md:h-[30rem] h-[16rem] overflow-hidden">
          <Canvas className="w-full mx-auto sm:w-full h-full ">
            {/* <OrbitControls
              zoomSpeed={0.3}
              zoom0={0.3}
              minZoom={3}
      ...
      <section className="max-w-xl mt-12 mx-auto px-4 font-medium">
      ...
      <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto mt-5">
        <div className="max-w-lg sm:mx-auto sm:text-center">
          <img
            src="https://scaliton.vercel.app/swastika.png"
            className="w-32 sm:mx-auto mx-auto"
          />
        ...
        <div className="mt-8 items-center justify-between sm:flex">
          <div className="mt-4 sm:mt-0">
            &copy; 2022 Scaliton All rights reserved.
          </div>
